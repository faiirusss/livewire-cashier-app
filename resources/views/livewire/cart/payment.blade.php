            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <div class="flex flex-col items-center pb-4 mb-3 border-b border-dashed">
                        ...
                        <span
                            class="text-sm text-gray-500 ">{{ \Carbon\Carbon::parse($order->created_at)->translatedFormat('d F Y H:i') }}
                            WIB</span>
                    </div>
                    ...
                    @if ($order->paid_amount == null)
                        <div class="flex justify-between">
                            <span class="text-sm font-normal text-gray-600">Total Harga ({{ $total_qty }}
                                Barang)</span>
                            <span
                                class="text-sm font-normal text-gray-800">Rp{{ number_format($total_price, 0, ',', '.') }}</span>
                        </div>
                        @if ($order->discount_price !== 0)
                            <div class="flex justify-between">
                                <span class="text-sm font-normal text-gray-600">Total Diskon Barang</span>
                                <span
                                    class="text-sm font-normal text-gray-800">-Rp{{ number_format($order->discount_price, 0, ',', '.') }}</span>
                            </div>
                        @endif
                        <div class="flex justify-between pb-3 mb-3 border-b border-dashed">
                            <span class="text-sm font-normal text-gray-600">PPN 5%</span>
                            <span
                                class="text-sm font-normal text-gray-800">Rp{{ number_format($ppn, 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between pb-3 mb-3 border-b border-dashed">
                    ...
                    @else
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="text-sm font-normal text-gray-800">Rp{{ number_format($paid_amount, 0, ',', '.') }}</span>
                        </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <div class="flex justify-between">
                        <span class="text-sm font-normal text-gray-600">PPN 5%</span>
                        <span
                            class="text-sm font-normal text-gray-800">Rp{{ number_format(ceil($total_price * 0.05), 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm font-normal text-gray-600">Total Pembayaran</span>
                        <span
                            class="text-sm font-normal text-gray-800">Rp{{ number_format($order->grand_total, 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between pb-3 mb-3 border-b border-dashed">
                        <span class="text-sm font-normal text-gray-600">Kembali</span>
